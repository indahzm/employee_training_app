...
import co.id.employeetrainingsecurity.entity.RolePath;
import co.id.employeetrainingsecurity.entity.User;
import co.id.employeetrainingsecurity.repository.ClientRepository;
import co.id.employeetrainingsecurity.repository.RolePathRepository;
    ...
    public void insertClients(String password) { 
        for (String c: clients) { 
            ...
            if (null == oldClient) { 
                ...
                oldClient.setAccessTokenExpired(28800);//1 jam 3600 :token valid : seharian kerja : normal 1 jam 
                oldClient.setRefreshTokenExpired(7257600);// refresh 
