...
public class EmailTemplate {
	public String getRegistrationTemplate() {
		return "<!DOCTYPE html>\n" + 
                ...
                "\t\tkode: <a href=\"{{URL}}\">{{VERIFY_URL}}</a>\n" + 
                "\t\t\n" + 
                "\t\t<p class=\"mt--15\">Jika kamu butuh bantuan atau pertanyaan, hubungi customer care kami di 081213 atau kirim email ke indah.zakiyyah@idstar.group</p>\n" + 
                "\t\t\n" + 
